...
#from matplotlib.backends.backend_qt5cairo import FigureCanvasQT as FigureCanvas
...
class MyNavigationToolbar(NavigationToolbar) :
    ...
    def __init__(self , canvas , parent , direction = 'h' ) :
        ...
        if direction=='h' :    self.layout = PyQt5.QtWidgets.QHBoxLayout#( self )
        else : self.layout = PyQt5.QtWidgets.QVBoxLayout#( self )
